...
<div>
  ...
  <div class="icon-row">
    ...
    <a href="mailto:brandenb@ucla.edu" target="_blank" rel="noopener noreferrer">
      <svg class="icon-link" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
  ...
  <p>
    I'm Branden, and I do research and game development.<br>
    Here, you can find my latest work. Enjoy your stay!
  </p>
